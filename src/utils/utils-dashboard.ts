...
export class Dashboard implements DashboardInterface {
  ...
  constructor(dashboard: IDashboardDetail) {
    ...
    this.utilizedChains = dashboard.utilizedChains;
