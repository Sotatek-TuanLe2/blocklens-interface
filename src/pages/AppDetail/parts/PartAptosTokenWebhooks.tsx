...
const PartAptosTokenWebhooks: FC<IListContract> = ({ appInfo }) => {
  ...
  const _renderNoData = () => {
    return (
      <Flex className="box-create">
        ...
        Create your webhook to start experiencing Blocklens with Aptos Token
        Activity!
        <AppButton
          ...
          onClick={() =>
            history.push(
              `/create-webhook/${appInfo.appId}?type=${WEBHOOK_TYPES.APTOS_TOKEN_ACTIVITY}`,
            )
          }
        >
          Create
    ...
    <>
      ...
      >
        <Box className="description">
          Get notified whenever a token occurs activity
        </Box>
      </Flex>
...
export default PartAptosTokenWebhooks;
